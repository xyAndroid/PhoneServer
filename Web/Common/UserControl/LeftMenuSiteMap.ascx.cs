...
namespace SCMS.Web.Common.UserControl
{
    public partial class LeftMenuSiteMap : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                case SYNCRoleName.User: this.SiteMapDataSource1.SiteMapProvider = "Administrator"; break;
                //case SCMSRoleName.Teacher: this.SiteMapDataSource1.SiteMapProvider = "Teacher"; break;
                //case SCMSRoleName.Student: this.SiteMapDataSource1.SiteMapProvider = "Students"; break;
                // case SCMSRoleName.DepartmentManager: this.SiteMapDataSource1.SiteMapProvider = "DepartmentManager"; break;
                // case SCMSRoleName.ReviewExpert: this.SiteMapDataSource1.SiteMapProvider = "ReviewExpert"; break;
                // case SCMSRoleName.GuidanceTeacherLeader: this.SiteMapDataSource1.SiteMapProvider = "GuidanceTeacherLeader"; break;
                // case SCMSRoleName.Project: this.SiteMapDataSource1.SiteMapProvider = "Project"; break;
